...
## Confidence / Gaps
Total packets analyzed: 10818677. Findings are heuristic and packet-based.
...
- initial_access: supported=True weakly_supported=False confidence=0.9 first_seen=2025-12-20T12:13:45.382800+00:00 evidence=External RDP from 141.98.83.70 into 10.128.239.57 shows handshake/application evidence and post-login behavior change.
- discovery: supported=False weakly_supported=True confidence=0.35 first_seen=2025-12-20T13:03:15.693006+00:00 evidence=10.128.239.57 generated limited SMB/RPC probing toward 3 internal targets, but it stayed below the stronger detection threshold.
...
Best ingress candidate: external `141.98.83.70` -> internal `10.128.239.57` with confidence `65`.
...
- 141.98.83.70 -> 10.128.239.57 packets=29880 app_packets=19200 post_login_targets=5 suspicious=True
- 179.60.146.30 -> 10.128.239.57 packets=24576 app_packets=15816 post_login_targets=5 suspicious=True
- 91.224.92.23 -> 10.128.239.57 packets=24338 app_packets=13816 post_login_targets=5 suspicious=True
- 141.98.11.49 -> 10.128.239.57 packets=23680 app_packets=12943 post_login_targets=5 suspicious=True
- 98.159.33.100 -> 10.128.239.57 packets=4518 app_packets=2898 post_login_targets=5 suspicious=True
...
- SMB/RPC scan source 10.128.239.57 unique_targets=3 attempts=4 duration=159409.85
