...
## Confidence / Gaps
Total packets analyzed: 6391. Findings are heuristic and packet-based.
...
- initial_access: supported=True weakly_supported=False confidence=0.9 first_seen=2025-12-13T04:16:21.219347+00:00 evidence=External RDP from 194.165.17.11 into 10.128.239.57 shows handshake/application evidence and post-login behavior change.
...
- 194.165.17.11 -> 10.128.239.57 packets=728 app_packets=440 post_login_targets=0 suspicious=True
- 91.238.181.91 -> 10.128.239.57 packets=521 app_packets=319 post_login_targets=0 suspicious=True
- 88.214.25.115 -> 10.128.239.57 packets=388 app_packets=233 post_login_targets=0 suspicious=True
- 88.214.25.123 -> 10.128.239.57 packets=188 app_packets=114 post_login_targets=0 suspicious=True
- 98.159.33.51 -> 10.128.239.57 packets=154 app_packets=99 post_login_targets=0 suspicious=True
