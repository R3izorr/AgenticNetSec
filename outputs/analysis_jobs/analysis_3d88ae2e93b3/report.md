...
## Initial Access
Most likely patient zero is 10.128.239.57 after ingress from 45.130.145.40 over RDP.
...
## Confidence / Gaps
Total packets analyzed: 1542486. Findings are heuristic and packet-based.
...
- initial_access: supported=True weakly_supported=False confidence=0.9 first_seen=2026-01-06T11:58:18.273510+00:00 evidence=External RDP from 45.130.145.40 into 10.128.239.57 shows handshake/application evidence and post-login behavior change.
- discovery: supported=False weakly_supported=True confidence=0.35 first_seen=2026-01-06T11:58:22.768761+00:00 evidence=10.128.239.57 generated limited SMB/RPC probing toward 5 internal targets, but it stayed below the stronger detection threshold.
- administrative_activity: supported=False weakly_supported=True confidence=0.35 first_seen=2026-01-06T17:07:07.994904+00:00 evidence=Generic SMB/DCERPC marker strings were observed near the focus host, but they did not meet the account-change threshold.
...
Best ingress candidate: external `45.130.145.40` -> internal `10.128.239.57` with confidence `68`.
...
- 45.130.145.40 -> 10.128.239.57 packets=70434 app_packets=42918 post_login_targets=6 suspicious=True
- 179.60.146.36 -> 10.128.239.57 packets=48923 app_packets=31461 post_login_targets=6 suspicious=True
- 141.98.83.10 -> 10.128.239.57 packets=38540 app_packets=24757 post_login_targets=6 suspicious=True
- 45.135.232.19 -> 10.128.239.57 packets=26728 app_packets=16216 post_login_targets=6 suspicious=True
- 45.92.229.189 -> 10.128.239.57 packets=23647 app_packets=14240 post_login_targets=6 suspicious=True
...
- SMB/RPC scan source 10.128.239.57 unique_targets=5 attempts=6 duration=32739.4
...
- `ip.addr == 45.130.145.40 and ip.addr == 10.128.239.57 and tcp.port == 3389`
