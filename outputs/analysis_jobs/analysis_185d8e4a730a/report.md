...
## Confidence / Gaps
Total packets analyzed: 15819. Findings are heuristic and packet-based.
...
- initial_access: supported=True weakly_supported=False confidence=0.9 first_seen=2026-01-13T21:11:25.679175+00:00 evidence=External RDP from 194.165.17.11 into 10.128.239.57 shows handshake/application evidence and post-login behavior change.
- discovery: supported=False weakly_supported=True confidence=0.35 first_seen=2026-01-13T21:25:35.096505+00:00 evidence=10.128.239.57 generated limited SMB/RPC probing toward 1 internal targets, but it stayed below the stronger detection threshold.
...
- 194.165.17.11 -> 10.128.239.57 packets=2154 app_packets=1302 post_login_targets=1 suspicious=True
- 45.227.254.152 -> 10.128.239.57 packets=1058 app_packets=664 post_login_targets=1 suspicious=True
- 88.214.25.115 -> 10.128.239.57 packets=807 app_packets=469 post_login_targets=1 suspicious=True
- 98.159.33.51 -> 10.128.239.57 packets=252 app_packets=162 post_login_targets=1 suspicious=True
- 91.238.181.91 -> 10.128.239.57 packets=271 app_packets=165 post_login_targets=1 suspicious=True
