...
## Confidence / Gaps
Total packets analyzed: 329789. Findings are heuristic and packet-based.
...
- initial_access: supported=True weakly_supported=False confidence=0.9 first_seen=2026-01-08T23:03:45.262568+00:00 evidence=External RDP from 194.165.17.11 into 10.128.239.57 shows handshake/application evidence and post-login behavior change.
...
- 194.165.17.11 -> 10.128.239.57 packets=300 app_packets=182 post_login_targets=0 suspicious=True
- 88.214.25.123 -> 10.128.239.57 packets=209 app_packets=127 post_login_targets=0 suspicious=True
- 88.214.25.115 -> 10.128.239.57 packets=97 app_packets=56 post_login_targets=0 suspicious=True
- 98.159.33.51 -> 10.128.239.57 packets=42 app_packets=27 post_login_targets=0 suspicious=True
- 80.91.223.58 -> 10.128.239.57 packets=28 app_packets=18 post_login_targets=0 suspicious=True
