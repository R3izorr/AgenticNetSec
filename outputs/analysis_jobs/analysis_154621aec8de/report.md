...
## Confidence / Gaps
Total packets analyzed: 1071543. Findings are heuristic and packet-based.
...
- initial_access: supported=True weakly_supported=False confidence=0.9 first_seen=2025-12-04T23:45:13.250029+00:00 evidence=External RDP from 141.98.11.170 into 10.128.239.57 shows handshake/application evidence and post-login behavior change.
- discovery: supported=False weakly_supported=True confidence=0.35 first_seen=2025-12-04T23:45:36.194911+00:00 evidence=10.128.239.57 generated limited SMB/RPC probing toward 5 internal targets, but it stayed below the stronger detection threshold.
...
Best ingress candidate: external `141.98.11.170` -> internal `10.128.239.57` with confidence `68`.
...
- 141.98.11.170 -> 10.128.239.57 packets=96019 app_packets=57490 post_login_targets=6 suspicious=True
- 141.98.11.109 -> 10.128.239.57 packets=76820 app_packets=47137 post_login_targets=6 suspicious=True
- 141.98.11.8 -> 10.128.239.57 packets=69039 app_packets=37884 post_login_targets=6 suspicious=True
- 45.130.145.40 -> 10.128.239.57 packets=27362 app_packets=16664 post_login_targets=6 suspicious=True
- 45.140.17.72 -> 10.128.239.57 packets=23945 app_packets=13781 post_login_targets=6 suspicious=True
...
- SMB/RPC scan source 10.128.239.57 unique_targets=5 attempts=7 duration=31322.62
