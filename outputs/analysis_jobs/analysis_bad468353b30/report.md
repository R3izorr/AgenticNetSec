...
## Confidence / Gaps
Total packets analyzed: 10857. Findings are heuristic and packet-based.
...
- initial_access: supported=True weakly_supported=False confidence=0.9 first_seen=2025-12-08T19:42:45.866176+00:00 evidence=External RDP from 194.165.17.11 into 10.128.239.57 shows handshake/application evidence and post-login behavior change.
- discovery: supported=False weakly_supported=True confidence=0.35 first_seen=2025-12-08T20:03:12.876243+00:00 evidence=10.128.239.57 generated limited SMB/RPC probing toward 1 internal targets, but it stayed below the stronger detection threshold.
- administrative_activity: supported=False weakly_supported=True confidence=0.35 first_seen=2025-12-08T20:03:13.536341+00:00 evidence=Generic SMB/DCERPC marker strings were observed near the focus host, but they did not meet the account-change threshold.
...
- 194.165.17.11 -> 10.128.239.57 packets=1072 app_packets=648 post_login_targets=1 suspicious=True
- 91.238.181.7 -> 10.128.239.57 packets=787 app_packets=481 post_login_targets=1 suspicious=True
- 91.238.181.93 -> 10.128.239.57 packets=423 app_packets=260 post_login_targets=1 suspicious=True
- 88.214.25.115 -> 10.128.239.57 packets=346 app_packets=198 post_login_targets=1 suspicious=True
- 98.159.33.100 -> 10.128.239.57 packets=145 app_packets=90 post_login_targets=1 suspicious=True
