...
## Confidence / Gaps
Total packets analyzed: 1267447. Findings are heuristic and packet-based.
...
- initial_access: supported=True weakly_supported=False confidence=0.9 first_seen=2026-01-18T20:17:22.281259+00:00 evidence=External RDP from 141.98.11.49 into 10.128.239.57 shows handshake/application evidence and post-login behavior change.
- discovery: supported=False weakly_supported=True confidence=0.35 first_seen=2026-01-18T20:17:59.923890+00:00 evidence=10.128.239.57 generated limited SMB/RPC probing toward 2 internal targets, but it stayed below the stronger detection threshold.
- administrative_activity: supported=False weakly_supported=True confidence=0.35 first_seen=2026-01-20T04:16:57.300220+00:00 evidence=Generic SMB/DCERPC marker strings were observed near the focus host, but they did not meet the account-change threshold.
...
Best ingress candidate: external `141.98.11.49` -> internal `10.128.239.57` with confidence `56`.
...
- 141.98.11.49 -> 10.128.239.57 packets=95939 app_packets=51187 post_login_targets=2 suspicious=True
- 179.60.146.35 -> 10.128.239.57 packets=73221 app_packets=47110 post_login_targets=2 suspicious=True
- 179.60.146.31 -> 10.128.239.57 packets=69288 app_packets=44572 post_login_targets=2 suspicious=True
- 179.60.145.15 -> 10.128.239.57 packets=36642 app_packets=21400 post_login_targets=2 suspicious=True
- 45.135.232.37 -> 10.128.239.57 packets=24538 app_packets=14797 post_login_targets=2 suspicious=True
...
- SMB/RPC scan source 10.128.239.57 unique_targets=2 attempts=4 duration=79798.91
