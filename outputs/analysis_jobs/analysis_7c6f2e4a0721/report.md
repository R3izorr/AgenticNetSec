...
## Confidence / Gaps
Total packets analyzed: 4130498. Findings are heuristic and packet-based.
...
- initial_access: supported=True weakly_supported=False confidence=0.9 first_seen=2026-01-10T01:55:26.989218+00:00 evidence=External RDP from 141.98.11.109 into 10.128.239.57 shows handshake/application evidence and post-login behavior change.
- discovery: supported=False weakly_supported=True confidence=0.35 first_seen=2026-01-10T02:52:38.688199+00:00 evidence=10.128.239.57 generated limited SMB/RPC probing toward 5 internal targets, but it stayed below the stronger detection threshold.
...
- 141.98.11.109 -> 10.128.239.57 packets=11794 app_packets=7241 post_login_targets=5 suspicious=True
- 91.238.181.6 -> 10.128.239.57 packets=9907 app_packets=6043 post_login_targets=5 suspicious=True
- 141.98.11.170 -> 10.128.239.57 packets=10006 app_packets=5997 post_login_targets=5 suspicious=True
- 91.238.181.8 -> 10.128.239.57 packets=8462 app_packets=5024 post_login_targets=5 suspicious=True
- 141.98.11.114 -> 10.128.239.57 packets=5512 app_packets=3330 post_login_targets=5 suspicious=True
...
- SMB/RPC scan source 10.128.239.57 unique_targets=5 attempts=7 duration=68167.73
