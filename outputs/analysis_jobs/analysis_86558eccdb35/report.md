...
## Confidence / Gaps
Total packets analyzed: 323650. Findings are heuristic and packet-based.
...
- initial_access: supported=True weakly_supported=False confidence=0.9 first_seen=2025-12-17T12:31:35.581983+00:00 evidence=External RDP from 91.238.181.8 into 10.128.239.57 shows handshake/application evidence and post-login behavior change.
- discovery: supported=False weakly_supported=True confidence=0.35 first_seen=2025-12-17T13:12:51.250191+00:00 evidence=10.128.239.57 generated limited SMB/RPC probing toward 3 internal targets, but it stayed below the stronger detection threshold.
- administrative_activity: supported=False weakly_supported=True confidence=0.35 first_seen=2025-12-17T23:39:12.978681+00:00 evidence=Generic SMB/DCERPC marker strings were observed near the focus host, but they did not meet the account-change threshold.
...
Best ingress candidate: external `91.238.181.8` -> internal `10.128.239.57` with confidence `59`.
...
- 91.238.181.8 -> 10.128.239.57 packets=13353 app_packets=8108 post_login_targets=3 suspicious=True
- 45.227.254.3 -> 10.128.239.57 packets=10223 app_packets=6230 post_login_targets=3 suspicious=True
- 91.238.181.6 -> 10.128.239.57 packets=9471 app_packets=5775 post_login_targets=3 suspicious=True
- 91.238.181.7 -> 10.128.239.57 packets=9458 app_packets=5735 post_login_targets=3 suspicious=True
- 98.159.33.100 -> 10.128.239.57 packets=8275 app_packets=5303 post_login_targets=3 suspicious=True
...
- SMB/RPC scan source 10.128.239.57 unique_targets=3 attempts=5 duration=38306.49
