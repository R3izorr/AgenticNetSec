...
## Confidence / Gaps
Total packets analyzed: 2119300. Findings are heuristic and packet-based.
...
- initial_access: supported=True weakly_supported=False confidence=0.9 first_seen=2026-01-22T16:16:47.611347+00:00 evidence=External RDP from 141.98.83.70 into 10.128.239.57 shows handshake/application evidence and post-login behavior change.
- discovery: supported=False weakly_supported=True confidence=0.35 first_seen=2026-01-22T16:18:07.820932+00:00 evidence=10.128.239.57 generated limited SMB/RPC probing toward 3 internal targets, but it stayed below the stronger detection threshold.
- administrative_activity: supported=False weakly_supported=True confidence=0.35 first_seen=2026-01-22T22:24:12.271359+00:00 evidence=Generic SMB/DCERPC marker strings were observed near the focus host, but they did not meet the account-change threshold.
...
Best ingress candidate: external `141.98.83.70` -> internal `10.128.239.57` with confidence `62`.
...
- 141.98.83.70 -> 10.128.239.57 packets=98347 app_packets=63079 post_login_targets=4 suspicious=True
- 179.60.146.33 -> 10.128.239.57 packets=81239 app_packets=52142 post_login_targets=4 suspicious=True
- 141.98.11.114 -> 10.128.239.57 packets=76610 app_packets=46272 post_login_targets=4 suspicious=True
- 141.98.11.144 -> 10.128.239.57 packets=72631 app_packets=43449 post_login_targets=4 suspicious=True
- 147.45.112.181 -> 10.128.239.57 packets=44626 app_packets=27146 post_login_targets=4 suspicious=True
...
- SMB/RPC scan source 10.128.239.57 unique_targets=3 attempts=4 duration=2823.83
