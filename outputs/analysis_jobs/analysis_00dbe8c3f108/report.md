...
Rapid SMB/RPC scanning was observed from 10.128.239.57 (148 targets)

## Exfiltration
No direct temp.sh indicator was found.

## Payload Deployment
Heuristic deployment evidence is present through correlated RDP plus SMB/DCERPC admin-share activity from 10.128.239.57 to 75 hosts (admin_share_targets=0, remote_exec_targets=0). Confidence=0.00.

## Confidence / Gaps
Total packets analyzed: 6162722. Findings are heuristic and packet-based.
...
- initial_access: supported=True weakly_supported=False confidence=0.9 first_seen=2026-01-05T18:15:36.366573+00:00 evidence=External RDP from 179.60.146.36 into 10.128.239.57 shows handshake/application evidence and post-login behavior change.
- discovery: supported=True weakly_supported=False confidence=0.9 first_seen=2026-01-05T18:19:50.424783+00:00 evidence=10.128.239.57 generated SMB/RPC scanning toward 148 internal targets.
...
- payload_deployment: supported=True weakly_supported=False confidence=0.9 first_seen=2026-01-09T11:11:32.158450+00:00 evidence=Internal RDP plus SMB/DCERPC correlations are consistent with manual payload deployment.
Best ingress candidate: external `179.60.146.36` -> internal `10.128.239.57` with confidence `80`.
...
- 179.60.146.36 -> 10.128.239.57 packets=15968 app_packets=10288 post_login_targets=153 suspicious=True
- 141.98.83.10 -> 10.128.239.57 packets=13109 app_packets=8417 post_login_targets=153 suspicious=True
- 141.98.11.109 -> 10.128.239.57 packets=14086 app_packets=8637 post_login_targets=153 suspicious=True
- 141.98.11.8 -> 10.128.239.57 packets=12208 app_packets=6460 post_login_targets=153 suspicious=True
- 141.98.11.127 -> 10.128.239.57 packets=11372 app_packets=5462 post_login_targets=153 suspicious=True
...
- SMB/RPC scan source 10.128.239.57 unique_targets=148 attempts=160 duration=638870.18
- Internal RDP spread source 10.128.239.57 unique_targets=99 sessions=99 duration=321814.47
...
- Manual-drop candidate 10.128.239.57 targets=75 smb_targets=75 admin_share_targets=0 remote_exec_targets=0 score=100
- Internal RDP spread source 10.128.239.57 unique_targets=99 sessions=99 duration=321814.47
