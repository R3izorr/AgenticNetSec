...
## Confidence / Gaps
Total packets analyzed: 1391999. Findings are heuristic and packet-based.
...
- initial_access: supported=True weakly_supported=False confidence=0.9 first_seen=2025-11-24T20:13:27.120744+00:00 evidence=External RDP from 179.60.146.30 into 10.128.239.57 shows handshake/application evidence and post-login behavior change.
- discovery: supported=False weakly_supported=True confidence=0.35 first_seen=2025-11-24T20:13:43.849799+00:00 evidence=10.128.239.57 generated limited SMB/RPC probing toward 4 internal targets, but it stayed below the stronger detection threshold.
- administrative_activity: supported=False weakly_supported=True confidence=0.35 first_seen=2025-11-25T08:54:45.297575+00:00 evidence=Generic SMB/DCERPC marker strings were observed near the focus host, but they did not meet the account-change threshold.
...
Best ingress candidate: external `179.60.146.30` -> internal `10.128.239.57` with confidence `65`.
...
- 179.60.146.30 -> 10.128.239.57 packets=112219 app_packets=72160 post_login_targets=5 suspicious=True
- 91.224.92.23 -> 10.128.239.57 packets=110180 app_packets=62259 post_login_targets=5 suspicious=True
- 141.98.11.81 -> 10.128.239.57 packets=102654 app_packets=62252 post_login_targets=5 suspicious=True
- 179.60.146.34 -> 10.128.239.57 packets=45104 app_packets=28988 post_login_targets=5 suspicious=True
- 179.60.146.35 -> 10.128.239.57 packets=38786 app_packets=24928 post_login_targets=5 suspicious=True
...
- SMB/RPC scan source 10.128.239.57 unique_targets=4 attempts=6 duration=62421.87
