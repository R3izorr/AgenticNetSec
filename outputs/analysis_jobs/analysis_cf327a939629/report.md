...
## Confidence / Gaps
Total packets analyzed: 71901. Findings are heuristic and packet-based.
...
- initial_access: supported=True weakly_supported=False confidence=0.9 first_seen=2025-11-18T13:31:35.642744+00:00 evidence=External RDP from 194.165.17.11 into 10.128.239.57 shows handshake/application evidence and post-login behavior change.
- discovery: supported=False weakly_supported=True confidence=0.35 first_seen=2025-11-18T13:33:13.475733+00:00 evidence=10.128.239.57 generated limited SMB/RPC probing toward 1 internal targets, but it stayed below the stronger detection threshold.
...
- 194.165.17.11 -> 10.128.239.57 packets=1984 app_packets=1197 post_login_targets=2 suspicious=True
- 91.238.181.91 -> 10.128.239.57 packets=1026 app_packets=627 post_login_targets=2 suspicious=True
- 88.214.25.115 -> 10.128.239.57 packets=719 app_packets=418 post_login_targets=2 suspicious=True
- 147.45.112.183 -> 10.128.239.57 packets=660 app_packets=308 post_login_targets=2 suspicious=True
- 98.159.33.51 -> 10.128.239.57 packets=311 app_packets=199 post_login_targets=2 suspicious=True
