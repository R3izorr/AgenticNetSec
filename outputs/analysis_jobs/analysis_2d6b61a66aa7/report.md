...
## Confidence / Gaps
Total packets analyzed: 1681576. Findings are heuristic and packet-based.
...
- initial_access: supported=True weakly_supported=False confidence=0.9 first_seen=2025-12-13T21:30:25.720450+00:00 evidence=External RDP from 179.60.146.32 into 10.128.239.57 shows handshake/application evidence and post-login behavior change.
- discovery: supported=False weakly_supported=True confidence=0.35 first_seen=2025-12-13T21:35:19.188205+00:00 evidence=10.128.239.57 generated limited SMB/RPC probing toward 5 internal targets, but it stayed below the stronger detection threshold.
...
Best ingress candidate: external `179.60.146.32` -> internal `10.128.239.57` with confidence `65`.
...
- 179.60.146.32 -> 10.128.239.57 packets=74950 app_packets=48100 post_login_targets=5 suspicious=True
- 179.60.146.37 -> 10.128.239.57 packets=62402 app_packets=40088 post_login_targets=5 suspicious=True
- 194.165.17.11 -> 10.128.239.57 packets=62707 app_packets=36200 post_login_targets=5 suspicious=True
- 147.45.112.187 -> 10.128.239.57 packets=38500 app_packets=23444 post_login_targets=5 suspicious=True
- 147.45.112.183 -> 10.128.239.57 packets=36941 app_packets=22475 post_login_targets=5 suspicious=True
...
- SMB/RPC scan source 10.128.239.57 unique_targets=5 attempts=6 duration=117262.79
