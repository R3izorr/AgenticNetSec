...
## Confidence / Gaps
Total packets analyzed: 11192830. Findings are heuristic and packet-based.
...
- initial_access: supported=True weakly_supported=False confidence=0.9 first_seen=2026-01-04T17:35:41.650808+00:00 evidence=External RDP from 179.60.146.32 into 10.128.239.57 shows handshake/application evidence and post-login behavior change.
- discovery: supported=False weakly_supported=True confidence=0.35 first_seen=2026-01-04T18:12:18.293804+00:00 evidence=10.128.239.57 generated limited SMB/RPC probing toward 2 internal targets, but it stayed below the stronger detection threshold.
- administrative_activity: supported=False weakly_supported=True confidence=0.35 first_seen=2026-01-07T13:14:29.178077+00:00 evidence=Generic SMB/DCERPC marker strings were observed near the focus host, but they did not meet the account-change threshold.
...
Best ingress candidate: external `179.60.146.32` -> internal `10.128.239.57` with confidence `59`.
...
- 179.60.146.32 -> 10.128.239.57 packets=29056 app_packets=18752 post_login_targets=3 suspicious=True
- 179.60.146.37 -> 10.128.239.57 packets=28342 app_packets=18260 post_login_targets=3 suspicious=True
- 141.98.83.70 -> 10.128.239.57 packets=26591 app_packets=17097 post_login_targets=3 suspicious=True
- 141.98.11.53 -> 10.128.239.57 packets=23430 app_packets=13357 post_login_targets=3 suspicious=True
- 141.98.11.49 -> 10.128.239.57 packets=23226 app_packets=12603 post_login_targets=3 suspicious=True
...
- SMB/RPC scan source 10.128.239.57 unique_targets=2 attempts=3 duration=361632.49
