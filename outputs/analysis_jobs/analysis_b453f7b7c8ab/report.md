...
## Confidence / Gaps
Total packets analyzed: 11216179. Findings are heuristic and packet-based.
...
- initial_access: supported=True weakly_supported=False confidence=0.9 first_seen=2025-12-26T15:10:45.562648+00:00 evidence=External RDP from 179.60.146.33 into 10.128.239.57 shows handshake/application evidence and post-login behavior change.
- discovery: supported=False weakly_supported=True confidence=0.35 first_seen=2025-12-26T15:38:09.781377+00:00 evidence=10.128.239.57 generated limited SMB/RPC probing toward 5 internal targets, but it stayed below the stronger detection threshold.
- administrative_activity: supported=False weakly_supported=True confidence=0.35 first_seen=2026-01-02T11:49:34.952971+00:00 evidence=Generic SMB/DCERPC marker strings were observed near the focus host, but they did not meet the account-change threshold.
...
Best ingress candidate: external `179.60.146.33` -> internal `10.128.239.57` with confidence `65`.
...
- 179.60.146.33 -> 10.128.239.57 packets=35762 app_packets=23030 post_login_targets=5 suspicious=True
- 141.98.11.114 -> 10.128.239.57 packets=28759 app_packets=16916 post_login_targets=5 suspicious=True
- 141.98.11.53 -> 10.128.239.57 packets=25581 app_packets=14352 post_login_targets=5 suspicious=True
- 45.135.232.37 -> 10.128.239.57 packets=18761 app_packets=10959 post_login_targets=5 suspicious=True
- 141.98.11.100 -> 10.128.239.57 packets=19829 app_packets=10135 post_login_targets=5 suspicious=True
...
- SMB/RPC scan source 10.128.239.57 unique_targets=5 attempts=5 duration=325887.24
