...
## Confidence / Gaps
Total packets analyzed: 414728. Findings are heuristic and packet-based.
...
- initial_access: supported=True weakly_supported=False confidence=0.9 first_seen=2025-12-08T07:53:08.629717+00:00 evidence=External RDP from 91.238.181.8 into 10.128.239.57 shows handshake/application evidence and post-login behavior change.
- discovery: supported=False weakly_supported=True confidence=0.35 first_seen=2025-12-08T08:48:43.722975+00:00 evidence=10.128.239.57 generated limited SMB/RPC probing toward 4 internal targets, but it stayed below the stronger detection threshold.
...
Best ingress candidate: external `91.238.181.8` -> internal `10.128.239.57` with confidence `62`.
...
- 91.238.181.8 -> 10.128.239.57 packets=16407 app_packets=9961 post_login_targets=4 suspicious=True
- 91.238.181.6 -> 10.128.239.57 packets=16323 app_packets=9961 post_login_targets=4 suspicious=True
- 194.165.17.11 -> 10.128.239.57 packets=12385 app_packets=7442 post_login_targets=4 suspicious=True
- 45.227.254.3 -> 10.128.239.57 packets=11108 app_packets=6770 post_login_targets=4 suspicious=True
- 91.238.181.7 -> 10.128.239.57 packets=10922 app_packets=6640 post_login_targets=4 suspicious=True
...
- SMB/RPC scan source 10.128.239.57 unique_targets=4 attempts=6 duration=52071.52
