...
## Confidence / Gaps
Total packets analyzed: 6160. Findings are heuristic and packet-based.
...
- initial_access: supported=True weakly_supported=False confidence=0.9 first_seen=2025-12-13T04:01:09.835819+00:00 evidence=External RDP from 194.165.17.11 into 10.128.239.57 shows handshake/application evidence and post-login behavior change.
...
- 194.165.17.11 -> 10.128.239.57 packets=383 app_packets=231 post_login_targets=0 suspicious=True
- 88.214.25.121 -> 10.128.239.57 packets=337 app_packets=201 post_login_targets=0 suspicious=True
- 88.214.25.123 -> 10.128.239.57 packets=323 app_packets=198 post_login_targets=0 suspicious=True
- 88.214.25.115 -> 10.128.239.57 packets=192 app_packets=108 post_login_targets=0 suspicious=True
- 185.91.127.19 -> 10.128.239.57 packets=42 app_packets=27 post_login_targets=0 suspicious=True
