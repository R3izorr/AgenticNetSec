...
## Confidence / Gaps
Total packets analyzed: 3933006. Findings are heuristic and packet-based.
...
- initial_access: supported=True weakly_supported=False confidence=0.9 first_seen=2026-01-27T06:47:39.833148+00:00 evidence=External RDP from 141.98.11.109 into 10.128.239.57 shows handshake/application evidence and post-login behavior change.
- discovery: supported=False weakly_supported=True confidence=0.35 first_seen=2026-01-27T07:11:52.522346+00:00 evidence=10.128.239.57 generated limited SMB/RPC probing toward 6 internal targets, but it stayed below the stronger detection threshold.
- administrative_activity: supported=False weakly_supported=True confidence=0.35 first_seen=2026-01-28T02:03:09.215057+00:00 evidence=Generic SMB/DCERPC marker strings were observed near the focus host, but they did not meet the account-change threshold.
...
Best ingress candidate: external `141.98.11.109` -> internal `10.128.239.57` with confidence `68`.
...
- 141.98.11.109 -> 10.128.239.57 packets=10734 app_packets=6581 post_login_targets=6 suspicious=True
- 141.98.11.114 -> 10.128.239.57 packets=9480 app_packets=5723 post_login_targets=6 suspicious=True
- 141.98.11.170 -> 10.128.239.57 packets=9241 app_packets=5544 post_login_targets=6 suspicious=True
- 91.238.181.8 -> 10.128.239.57 packets=3425 app_packets=2051 post_login_targets=6 suspicious=True
- 91.238.181.6 -> 10.128.239.57 packets=2945 app_packets=1797 post_login_targets=6 suspicious=True
...
- SMB/RPC scan source 10.128.239.57 unique_targets=6 attempts=6 duration=68689.25

### Administrative Activity Pivot
Possible account or group administration markers were observed over SMB/DCERPC.
- DCERPC markers 10.128.239.57 -> 10.128.239.32 markers={'c$': 1}
