...
## Confidence / Gaps
Total packets analyzed: 2274302. Findings are heuristic and packet-based.
...
- initial_access: supported=True weakly_supported=False confidence=0.9 first_seen=2025-12-08T19:31:37.515665+00:00 evidence=External RDP from 179.60.146.37 into 10.128.239.57 shows handshake/application evidence and post-login behavior change.
- discovery: supported=False weakly_supported=True confidence=0.35 first_seen=2025-12-08T19:32:42.078263+00:00 evidence=10.128.239.57 generated limited SMB/RPC probing toward 4 internal targets, but it stayed below the stronger detection threshold.
- administrative_activity: supported=False weakly_supported=True confidence=0.35 first_seen=2025-12-09T14:04:42.955213+00:00 evidence=Generic SMB/DCERPC marker strings were observed near the focus host, but they did not meet the account-change threshold.
...
Best ingress candidate: external `179.60.146.37` -> internal `10.128.239.57` with confidence `62`.
...
- 179.60.146.37 -> 10.128.239.57 packets=81637 app_packets=52421 post_login_targets=4 suspicious=True
- 179.60.146.32 -> 10.128.239.57 packets=76794 app_packets=49284 post_login_targets=4 suspicious=True
- 141.98.11.114 -> 10.128.239.57 packets=80906 app_packets=48779 post_login_targets=4 suspicious=True
- 194.165.17.11 -> 10.128.239.57 packets=71962 app_packets=41077 post_login_targets=4 suspicious=True
- 147.45.112.188 -> 10.128.239.57 packets=50518 app_packets=30710 post_login_targets=4 suspicious=True
...
- SMB/RPC scan source 10.128.239.57 unique_targets=4 attempts=5 duration=66716.97

### Administrative Activity Pivot
Possible account or group administration markers were observed over SMB/DCERPC.
- DCERPC markers 10.128.239.57 -> 10.128.239.23 markers={'c$': 3}
