...
## Confidence / Gaps
Total packets analyzed: 1211026. Findings are heuristic and packet-based.
...
- initial_access: supported=True weakly_supported=False confidence=0.9 first_seen=2025-12-08T20:09:33.296005+00:00 evidence=External RDP from 179.60.146.36 into 10.128.239.57 shows handshake/application evidence and post-login behavior change.
- discovery: supported=False weakly_supported=True confidence=0.35 first_seen=2025-12-08T20:09:36.886281+00:00 evidence=10.128.239.57 generated limited SMB/RPC probing toward 2 internal targets, but it stayed below the stronger detection threshold.
- administrative_activity: supported=False weakly_supported=True confidence=0.35 first_seen=2025-12-10T18:04:47.303550+00:00 evidence=Generic SMB/DCERPC marker strings were observed near the focus host, but they did not meet the account-change threshold.
...
Best ingress candidate: external `179.60.146.36` -> internal `10.128.239.57` with confidence `56`.
...
- 179.60.146.36 -> 10.128.239.57 packets=77428 app_packets=49823 post_login_targets=2 suspicious=True
- 141.98.83.10 -> 10.128.239.57 packets=73317 app_packets=47120 post_login_targets=2 suspicious=True
- 141.98.11.53 -> 10.128.239.57 packets=61521 app_packets=34443 post_login_targets=2 suspicious=True
- 141.98.11.8 -> 10.128.239.57 packets=59819 app_packets=33158 post_login_targets=2 suspicious=True
- 141.98.11.49 -> 10.128.239.57 packets=54363 app_packets=29053 post_login_targets=2 suspicious=True
...
- SMB/RPC scan source 10.128.239.57 unique_targets=2 attempts=4 duration=139341.31
