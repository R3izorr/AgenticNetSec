...
## Confidence / Gaps
Total packets analyzed: 1338833. Findings are heuristic and packet-based.
...
- initial_access: supported=True weakly_supported=False confidence=0.9 first_seen=2025-12-18T14:32:48.372207+00:00 evidence=External RDP from 141.98.11.170 into 10.128.239.57 shows handshake/application evidence and post-login behavior change.
- discovery: supported=False weakly_supported=True confidence=0.35 first_seen=2025-12-18T14:33:06.683882+00:00 evidence=10.128.239.57 generated limited SMB/RPC probing toward 3 internal targets, but it stayed below the stronger detection threshold.
- administrative_activity: supported=False weakly_supported=True confidence=0.35 first_seen=2025-12-19T18:21:32.665166+00:00 evidence=Generic SMB/DCERPC marker strings were observed near the focus host, but they did not meet the account-change threshold.
...
- 141.98.11.170 -> 10.128.239.57 packets=92355 app_packets=55437 post_login_targets=4 suspicious=True
- 194.0.234.17 -> 10.128.239.57 packets=73507 app_packets=44420 post_login_targets=4 suspicious=True
- 185.147.124.43 -> 10.128.239.57 packets=71400 app_packets=43511 post_login_targets=4 suspicious=True
- 92.255.85.174 -> 10.128.239.57 packets=51813 app_packets=26161 post_login_targets=4 suspicious=True
- 45.135.232.37 -> 10.128.239.57 packets=29480 app_packets=17852 post_login_targets=4 suspicious=True
...
- SMB/RPC scan source 10.128.239.57 unique_targets=3 attempts=4 duration=87967.41

### Administrative Activity Pivot
Possible account or group administration markers were observed over SMB/DCERPC.
- DCERPC markers 10.128.239.57 -> 10.128.239.29 markers={'c$': 4}
