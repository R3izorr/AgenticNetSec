...
## Initial Access
Most likely patient zero is 10.128.239.57 after ingress from 45.92.229.189 over RDP.
...
## Confidence / Gaps
Total packets analyzed: 1572406. Findings are heuristic and packet-based.
...
- initial_access: supported=True weakly_supported=False confidence=0.9 first_seen=2026-01-24T21:25:41.892083+00:00 evidence=External RDP from 45.92.229.189 into 10.128.239.57 shows handshake/application evidence and post-login behavior change.
- discovery: supported=False weakly_supported=True confidence=0.35 first_seen=2026-01-24T21:25:54.390770+00:00 evidence=10.128.239.57 generated limited SMB/RPC probing toward 5 internal targets, but it stayed below the stronger detection threshold.
- administrative_activity: supported=False weakly_supported=True confidence=0.35 first_seen=2026-01-25T11:46:42.434430+00:00 evidence=Generic SMB/DCERPC marker strings were observed near the focus host, but they did not meet the account-change threshold.
...
Best ingress candidate: external `45.92.229.189` -> internal `10.128.239.57` with confidence `68`.
...
- 45.92.229.189 -> 10.128.239.57 packets=21640 app_packets=13044 post_login_targets=6 suspicious=True
- 136.144.42.225 -> 10.128.239.57 packets=20527 app_packets=12446 post_login_targets=6 suspicious=True
- 98.159.33.18 -> 10.128.239.57 packets=17945 app_packets=11514 post_login_targets=6 suspicious=True
- 210.19.252.30 -> 10.128.239.57 packets=15556 app_packets=9996 post_login_targets=6 suspicious=True
- 45.140.17.73 -> 10.128.239.57 packets=15000 app_packets=9122 post_login_targets=6 suspicious=True
...
- SMB/RPC scan source 10.128.239.57 unique_targets=5 attempts=6 duration=2727.09
...
- `ip.addr == 45.92.229.189 and ip.addr == 10.128.239.57 and tcp.port == 3389`
