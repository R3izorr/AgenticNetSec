...
## Initial Access
Most likely patient zero is 10.128.239.57 after ingress from 141.98.11.144 over RDP.
...
## Confidence / Gaps
Total packets analyzed: 1976080. Findings are heuristic and packet-based.
...
- initial_access: supported=True weakly_supported=False confidence=0.9 first_seen=2025-12-04T01:33:10.848468+00:00 evidence=External RDP from 141.98.11.144 into 10.128.239.57 shows handshake/application evidence and post-login behavior change.
- discovery: supported=False weakly_supported=True confidence=0.35 first_seen=2025-12-04T01:33:37.140723+00:00 evidence=10.128.239.57 generated limited SMB/RPC probing toward 5 internal targets, but it stayed below the stronger detection threshold.
- administrative_activity: supported=False weakly_supported=True confidence=0.35 first_seen=2025-12-06T20:25:15.856045+00:00 evidence=Generic SMB/DCERPC marker strings were observed near the focus host, but they did not meet the account-change threshold.
...
Best ingress candidate: external `141.98.11.144` -> internal `10.128.239.57` with confidence `65`.
...
- 141.98.11.144 -> 10.128.239.57 packets=72696 app_packets=43369 post_login_targets=5 suspicious=True
- 141.98.11.114 -> 10.128.239.57 packets=72004 app_packets=43298 post_login_targets=5 suspicious=True
- 179.60.146.33 -> 10.128.239.57 packets=44835 app_packets=28788 post_login_targets=5 suspicious=True
- 179.60.146.37 -> 10.128.239.57 packets=40611 app_packets=26053 post_login_targets=5 suspicious=True
- 147.45.112.183 -> 10.128.239.57 packets=45236 app_packets=27508 post_login_targets=5 suspicious=True
...
- SMB/RPC scan source 10.128.239.57 unique_targets=5 attempts=6 duration=137725.57
...
- `ip.addr == 141.98.11.144 and ip.addr == 10.128.239.57 and tcp.port == 3389`
