...
## Confidence / Gaps
Total packets analyzed: 26877. Findings are heuristic and packet-based.
...
- initial_access: supported=True weakly_supported=False confidence=0.9 first_seen=2025-11-18T13:30:23.897899+00:00 evidence=External RDP from 91.238.181.7 into 10.128.239.57 shows handshake/application evidence and post-login behavior change.
- discovery: supported=False weakly_supported=True confidence=0.35 first_seen=2025-11-18T13:33:11.808991+00:00 evidence=10.128.239.57 generated limited SMB/RPC probing toward 1 internal targets, but it stayed below the stronger detection threshold.
- administrative_activity: supported=False weakly_supported=True confidence=0.35 first_seen=2025-11-18T13:33:12.458161+00:00 evidence=Generic SMB/DCERPC marker strings were observed near the focus host, but they did not meet the account-change threshold.
...
Best ingress candidate: external `91.238.181.7` -> internal `10.128.239.57` with confidence `56`.
...
- 91.238.181.7 -> 10.128.239.57 packets=2371 app_packets=1446 post_login_targets=2 suspicious=True
- 194.165.17.11 -> 10.128.239.57 packets=2357 app_packets=1430 post_login_targets=2 suspicious=True
- 98.159.33.100 -> 10.128.239.57 packets=462 app_packets=297 post_login_targets=2 suspicious=True
- 88.214.25.115 -> 10.128.239.57 packets=114 app_packets=67 post_login_targets=2 suspicious=True
- 138.199.59.143 -> 10.128.239.57 packets=96 app_packets=63 post_login_targets=2 suspicious=True
