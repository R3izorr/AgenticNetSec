...
## Confidence / Gaps
Total packets analyzed: 11019845. Findings are heuristic and packet-based.
...
- initial_access: supported=True weakly_supported=False confidence=0.9 first_seen=2026-01-04T15:53:20.662420+00:00 evidence=External RDP from 179.60.146.32 into 10.128.239.57 shows handshake/application evidence and post-login behavior change.
- discovery: supported=False weakly_supported=True confidence=0.35 first_seen=2026-01-04T16:16:46.385269+00:00 evidence=10.128.239.57 generated limited SMB/RPC probing toward 2 internal targets, but it stayed below the stronger detection threshold.
- administrative_activity: supported=False weakly_supported=True confidence=0.35 first_seen=2026-01-06T08:06:45.459269+00:00 evidence=Generic SMB/DCERPC marker strings were observed near the focus host, but they did not meet the account-change threshold.
...
Best ingress candidate: external `179.60.146.32` -> internal `10.128.239.57` with confidence `56`.
...
- 179.60.146.32 -> 10.128.239.57 packets=33423 app_packets=21581 post_login_targets=2 suspicious=True
- 179.60.146.37 -> 10.128.239.57 packets=32846 app_packets=21143 post_login_targets=2 suspicious=True
- 141.98.83.70 -> 10.128.239.57 packets=28341 app_packets=18205 post_login_targets=2 suspicious=True
- 141.98.11.53 -> 10.128.239.57 packets=25028 app_packets=14337 post_login_targets=2 suspicious=True
- 141.98.11.49 -> 10.128.239.57 packets=22276 app_packets=12111 post_login_targets=2 suspicious=True
...
- SMB/RPC scan source 10.128.239.57 unique_targets=2 attempts=3 duration=326694.0
