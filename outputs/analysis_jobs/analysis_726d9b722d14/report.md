...
## Confidence / Gaps
Total packets analyzed: 13361. Findings are heuristic and packet-based.
...
- initial_access: supported=True weakly_supported=False confidence=0.9 first_seen=2025-12-02T22:28:06.792081+00:00 evidence=External RDP from 194.165.17.11 into 10.128.239.57 shows handshake/application evidence and post-login behavior change.
...
- 194.165.17.11 -> 10.128.239.57 packets=1136 app_packets=686 post_login_targets=0 suspicious=True
- 91.238.181.93 -> 10.128.239.57 packets=1042 app_packets=635 post_login_targets=0 suspicious=True
- 91.238.181.96 -> 10.128.239.57 packets=831 app_packets=506 post_login_targets=0 suspicious=True
- 88.214.25.115 -> 10.128.239.57 packets=379 app_packets=218 post_login_targets=0 suspicious=True
- 98.159.33.51 -> 10.128.239.57 packets=185 app_packets=117 post_login_targets=0 suspicious=True
