...
## Confidence / Gaps
Total packets analyzed: 625115. Findings are heuristic and packet-based.
...
- initial_access: supported=True weakly_supported=False confidence=0.9 first_seen=2026-01-17T19:59:24.951046+00:00 evidence=External RDP from 179.60.146.32 into 10.128.239.57 shows handshake/application evidence and post-login behavior change.
- discovery: supported=False weakly_supported=True confidence=0.35 first_seen=2026-01-17T19:59:32.128850+00:00 evidence=10.128.239.57 generated limited SMB/RPC probing toward 4 internal targets, but it stayed below the stronger detection threshold.
- administrative_activity: supported=False weakly_supported=True confidence=0.35 first_seen=2026-01-18T03:21:39.451138+00:00 evidence=Generic SMB/DCERPC marker strings were observed near the focus host, but they did not meet the account-change threshold.
...
Best ingress candidate: external `179.60.146.32` -> internal `10.128.239.57` with confidence `62`.
...
- 179.60.146.32 -> 10.128.239.57 packets=14331 app_packets=9186 post_login_targets=4 suspicious=True
- 194.165.17.11 -> 10.128.239.57 packets=14406 app_packets=8469 post_login_targets=4 suspicious=True
- 45.140.17.72 -> 10.128.239.57 packets=12056 app_packets=7123 post_login_targets=4 suspicious=True
- 147.45.112.186 -> 10.128.239.57 packets=8579 app_packets=5235 post_login_targets=4 suspicious=True
- 88.214.25.122 -> 10.128.239.57 packets=7799 app_packets=4748 post_login_targets=4 suspicious=True
...
- SMB/RPC scan source 10.128.239.57 unique_targets=4 attempts=5 duration=84713.25
