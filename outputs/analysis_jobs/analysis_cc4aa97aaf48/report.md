...
## Confidence / Gaps
Total packets analyzed: 361309. Findings are heuristic and packet-based.
...
- initial_access: supported=True weakly_supported=False confidence=0.9 first_seen=2026-01-24T13:44:27.239569+00:00 evidence=External RDP from 141.98.11.114 into 10.128.239.57 shows handshake/application evidence and post-login behavior change.
- discovery: supported=False weakly_supported=True confidence=0.35 first_seen=2026-01-24T13:44:56.136546+00:00 evidence=10.128.239.57 generated limited SMB/RPC probing toward 6 internal targets, but it stayed below the stronger detection threshold.
...
Best ingress candidate: external `141.98.11.114` -> internal `10.128.239.57` with confidence `68`.
...
- 141.98.11.114 -> 10.128.239.57 packets=34815 app_packets=21090 post_login_targets=6 suspicious=True
- 141.98.11.170 -> 10.128.239.57 packets=34459 app_packets=20664 post_login_targets=6 suspicious=True
- 141.98.11.109 -> 10.128.239.57 packets=28047 app_packets=17222 post_login_targets=6 suspicious=True
- 91.238.181.8 -> 10.128.239.57 packets=5803 app_packets=3460 post_login_targets=6 suspicious=True
- 98.159.33.100 -> 10.128.239.57 packets=4301 app_packets=2754 post_login_targets=6 suspicious=True
...
- SMB/RPC scan source 10.128.239.57 unique_targets=6 attempts=8 duration=15860.56
