...
## Confidence / Gaps
Total packets analyzed: 10502328. Findings are heuristic and packet-based.
...
- initial_access: supported=True weakly_supported=False confidence=0.9 first_seen=2025-11-18T13:30:14.058125+00:00 evidence=External RDP from 141.98.83.70 into 10.128.239.57 shows handshake/application evidence and post-login behavior change.
- discovery: supported=False weakly_supported=True confidence=0.35 first_seen=2025-11-18T14:34:25.894573+00:00 evidence=10.128.239.57 generated limited SMB/RPC probing toward 2 internal targets, but it stayed below the stronger detection threshold.
...
Best ingress candidate: external `141.98.83.70` -> internal `10.128.239.57` with confidence `59`.
...
- 141.98.83.70 -> 10.128.239.57 packets=28647 app_packets=18412 post_login_targets=3 suspicious=True
- 179.60.146.32 -> 10.128.239.57 packets=21378 app_packets=13757 post_login_targets=3 suspicious=True
- 179.60.146.37 -> 10.128.239.57 packets=19978 app_packets=12869 post_login_targets=3 suspicious=True
- 141.98.11.49 -> 10.128.239.57 packets=23069 app_packets=12605 post_login_targets=3 suspicious=True
- 141.98.11.100 -> 10.128.239.57 packets=7692 app_packets=4251 post_login_targets=3 suspicious=True
...
- SMB/RPC scan source 10.128.239.57 unique_targets=2 attempts=3 duration=430057.6
