...
## Initial Access
Most likely patient zero is 10.128.239.57 after ingress from 141.98.11.114 over RDP.
...
## Confidence / Gaps
Total packets analyzed: 2035581. Findings are heuristic and packet-based.
...
- initial_access: supported=True weakly_supported=False confidence=0.9 first_seen=2025-11-18T17:33:33.125654+00:00 evidence=External RDP from 141.98.11.114 into 10.128.239.57 shows handshake/application evidence and post-login behavior change.
- discovery: supported=False weakly_supported=True confidence=0.35 first_seen=2025-11-18T17:34:15.067313+00:00 evidence=10.128.239.57 generated limited SMB/RPC probing toward 5 internal targets, but it stayed below the stronger detection threshold.
- administrative_activity: supported=False weakly_supported=True confidence=0.35 first_seen=2025-11-19T22:55:33.005035+00:00 evidence=Generic SMB/DCERPC marker strings were observed near the focus host, but they did not meet the account-change threshold.
...
Best ingress candidate: external `141.98.11.114` -> internal `10.128.239.57` with confidence `65`.
...
- 141.98.11.114 -> 10.128.239.57 packets=73043 app_packets=44016 post_login_targets=5 suspicious=True
- 141.98.11.144 -> 10.128.239.57 packets=71494 app_packets=42751 post_login_targets=5 suspicious=True
- 179.60.146.33 -> 10.128.239.57 packets=52946 app_packets=33974 post_login_targets=5 suspicious=True
- 147.45.112.188 -> 10.128.239.57 packets=41808 app_packets=25407 post_login_targets=5 suspicious=True
- 147.45.112.186 -> 10.128.239.57 packets=39315 app_packets=23890 post_login_targets=5 suspicious=True
...
- SMB/RPC scan source 10.128.239.57 unique_targets=5 attempts=6 duration=124844.36
...
- `ip.addr == 141.98.11.114 and ip.addr == 10.128.239.57 and tcp.port == 3389`
