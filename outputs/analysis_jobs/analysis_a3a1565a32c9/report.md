...
## Initial Access
Most likely patient zero is 10.128.239.57 after ingress from 179.60.146.35 over RDP.
...
## Confidence / Gaps
Total packets analyzed: 1047181. Findings are heuristic and packet-based.
...
- initial_access: supported=True weakly_supported=False confidence=0.9 first_seen=2025-12-17T12:52:07.706801+00:00 evidence=External RDP from 179.60.146.35 into 10.128.239.57 shows handshake/application evidence and post-login behavior change.
- discovery: supported=False weakly_supported=True confidence=0.35 first_seen=2025-12-17T12:52:45.259967+00:00 evidence=10.128.239.57 generated limited SMB/RPC probing toward 3 internal targets, but it stayed below the stronger detection threshold.
...
- payload_deployment: supported=False weakly_supported=True confidence=0.35 first_seen=2025-12-18T21:21:30.361990+00:00 evidence=Internal RDP fan-out suggests operator-driven payload staging, but no stronger correlated payload-drop indicator was isolated.
Best ingress candidate: external `179.60.146.35` -> internal `10.128.239.57` with confidence `80`.
...
- 179.60.146.35 -> 10.128.239.57 packets=91805 app_packets=59108 post_login_targets=21 suspicious=True
- 179.60.146.31 -> 10.128.239.57 packets=90006 app_packets=57907 post_login_targets=21 suspicious=True
- 141.98.11.49 -> 10.128.239.57 packets=100690 app_packets=53654 post_login_targets=21 suspicious=True
- 45.135.232.37 -> 10.128.239.57 packets=25608 app_packets=15456 post_login_targets=21 suspicious=True
- 179.60.146.36 -> 10.128.239.57 packets=21779 app_packets=14008 post_login_targets=20 suspicious=True
...
- SMB/RPC scan source 10.128.239.57 unique_targets=3 attempts=5 duration=35104.11
- Internal RDP spread source 10.128.239.57 unique_targets=14 sessions=14 duration=8055.26
...
- `ip.addr == 179.60.146.35 and ip.addr == 10.128.239.57 and tcp.port == 3389`
