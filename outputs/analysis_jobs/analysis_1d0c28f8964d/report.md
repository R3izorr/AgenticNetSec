...
## Confidence / Gaps
Total packets analyzed: 1296156. Findings are heuristic and packet-based.
...
- initial_access: supported=True weakly_supported=False confidence=0.9 first_seen=2025-12-09T12:47:42.497551+00:00 evidence=External RDP from 179.60.146.36 into 10.128.239.57 shows handshake/application evidence and post-login behavior change.
- discovery: supported=False weakly_supported=True confidence=0.35 first_seen=2025-12-09T12:47:45.575880+00:00 evidence=10.128.239.57 generated limited SMB/RPC probing toward 3 internal targets, but it stayed below the stronger detection threshold.
...
Best ingress candidate: external `179.60.146.36` -> internal `10.128.239.57` with confidence `62`.
...
- 179.60.146.36 -> 10.128.239.57 packets=96166 app_packets=61867 post_login_targets=4 suspicious=True
- 141.98.83.10 -> 10.128.239.57 packets=87080 app_packets=55965 post_login_targets=4 suspicious=True
- 141.98.11.49 -> 10.128.239.57 packets=79974 app_packets=42575 post_login_targets=4 suspicious=True
- 185.147.124.43 -> 10.128.239.57 packets=72242 app_packets=44034 post_login_targets=4 suspicious=True
- 141.98.11.8 -> 10.128.239.57 packets=73401 app_packets=40509 post_login_targets=4 suspicious=True
...
- SMB/RPC scan source 10.128.239.57 unique_targets=3 attempts=4 duration=37980.41
