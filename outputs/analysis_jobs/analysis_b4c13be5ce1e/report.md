...
## Confidence / Gaps
Total packets analyzed: 457250. Findings are heuristic and packet-based.
...
- initial_access: supported=True weakly_supported=False confidence=0.9 first_seen=2026-01-04T08:36:44.335395+00:00 evidence=External RDP from 141.98.11.170 into 10.128.239.57 shows handshake/application evidence and post-login behavior change.
- discovery: supported=False weakly_supported=True confidence=0.35 first_seen=2026-01-04T08:36:47.815313+00:00 evidence=10.128.239.57 generated limited SMB/RPC probing toward 5 internal targets, but it stayed below the stronger detection threshold.
- administrative_activity: supported=False weakly_supported=True confidence=0.35 first_seen=2026-01-04T18:43:36.573359+00:00 evidence=Generic SMB/DCERPC marker strings were observed near the focus host, but they did not meet the account-change threshold.
...
Best ingress candidate: external `141.98.11.170` -> internal `10.128.239.57` with confidence `65`.
...
- 141.98.11.170 -> 10.128.239.57 packets=38247 app_packets=22914 post_login_targets=5 suspicious=True
- 141.98.11.109 -> 10.128.239.57 packets=30279 app_packets=18591 post_login_targets=5 suspicious=True
- 45.140.17.72 -> 10.128.239.57 packets=23599 app_packets=13619 post_login_targets=5 suspicious=True
- 91.238.181.6 -> 10.128.239.57 packets=12042 app_packets=7349 post_login_targets=5 suspicious=True
- 141.98.11.8 -> 10.128.239.57 packets=12901 app_packets=7223 post_login_targets=5 suspicious=True
...
- SMB/RPC scan source 10.128.239.57 unique_targets=5 attempts=6 duration=58245.92
