...
## Confidence / Gaps
Total packets analyzed: 96349. Findings are heuristic and packet-based.
...
- initial_access: supported=True weakly_supported=False confidence=0.9 first_seen=2026-01-18T17:09:43.832354+00:00 evidence=External RDP from 194.165.17.11 into 10.128.239.57 shows handshake/application evidence and post-login behavior change.
- discovery: supported=False weakly_supported=True confidence=0.35 first_seen=2026-01-18T18:02:58.347329+00:00 evidence=10.128.239.57 generated limited SMB/RPC probing toward 1 internal targets, but it stayed below the stronger detection threshold.
...
- 194.165.17.11 -> 10.128.239.57 packets=12540 app_packets=7625 post_login_targets=1 suspicious=True
- 194.165.16.164 -> 10.128.239.57 packets=4393 app_packets=2830 post_login_targets=1 suspicious=True
- 91.238.181.7 -> 10.128.239.57 packets=3730 app_packets=2276 post_login_targets=1 suspicious=True
- 91.238.181.6 -> 10.128.239.57 packets=3665 app_packets=2235 post_login_targets=1 suspicious=True
- 45.227.254.3 -> 10.128.239.57 packets=2019 app_packets=1232 post_login_targets=1 suspicious=True
